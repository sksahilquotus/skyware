    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 space-y-8 pb-32 lg:pb-0">
          ...
          {getTotalItems() > 0 && (
            <div className="w-full lg:w-[300px] flex-shrink-0">
              <div className="sticky top-[35%]">
                <div className="bg-white rounded-2xl shadow-lg p-6 border-t-4 border-yellow-400 sticky top-20">
                  <div className="flex flex-col gap-4 mb-4">
                    ...
                    <div className="text-left">
                      <div className="text-2xl font-bold text-[#174166]">${getTotalPrice().toFixed(2)}</div>
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button className="bg-[#174166] hover:bg-[#1e4a73] px-8">Continue to Activities</Button>
                  </div>
                </div>
              </div>
            </div>
