        ...
        <div className="flex flex-col justify-between">
          <div>
            ...
            <p className="text-gray-600 text-sm mb-2 line-clamp-2">
              Luxurious guest room with modern amenities including Wi-Fi, sleeper
              sofa, marble bathroom, and more.
            </p>

            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-3 gap-y-1 text-sm text-gray-700 mb-2">
              {(showAllAmenities ? amenities : amenities.slice(0, 6)).map((item, idx) => (
            ...
            {!isSelected ? (
              <Dialog>
                <DialogTrigger asChild>
                  <Button className="w-full sm:w-auto px-4 bg-[#174166]">Select</Button>
                </DialogTrigger>
                <DialogContent className="sm:max-w-[400px]">
                  ...
                  <DialogFooter>
                    ...
                    <DialogClose asChild>
                      <Button className="bg-[#174166]" onClick={() => setIsSelected(true)}>
                        Confirm
                      </Button>
                    </DialogClose>
                  </DialogFooter>
              ...
              <Button disabled className="w-full sm:w-auto px-4 bg-orange-400">Selected</Button>
            )}
          </div>
        </div>
      </div>
